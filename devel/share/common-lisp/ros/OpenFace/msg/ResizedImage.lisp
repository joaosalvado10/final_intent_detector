...
(cl:defmethod cl:initialize-instance :after ((m <ResizedImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResizedImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name OpenFace-msg:<ResizedImage> is deprecated: use OpenFace-msg:ResizedImage instead.")))

(cl:ensure-generic-function 'original_height-val :lambda-list '(m))
(cl:defmethod original_height-val ((m <ResizedImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader OpenFace-msg:original_height-val is deprecated.  Use OpenFace-msg:original_height instead.")
  (original_height m))

(cl:ensure-generic-function 'original_width-val :lambda-list '(m))
(cl:defmethod original_width-val ((m <ResizedImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader OpenFace-msg:original_width-val is deprecated.  Use OpenFace-msg:original_width instead.")
  (original_width m))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <ResizedImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader OpenFace-msg:image-val is deprecated.  Use OpenFace-msg:image instead.")
  (image m))
